...
--
-- Name: cleanup_expired_ai_cache(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.cleanup_expired_ai_cache() RETURNS integer
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
...
--
-- Name: cleanup_old_activity_data(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.cleanup_old_activity_data() RETURNS TABLE(team_activity_deleted integer, task_activity_deleted integer, notifications_deleted integer)
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
...
--
-- Name: delete_entity_comments(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.delete_entity_comments() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: is_team_creator(uuid, uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.is_team_creator(p_team_id uuid, p_user_id uuid) RETURNS boolean
    LANGUAGE sql STABLE SECURITY DEFINER
    AS $$
  SELECT EXISTS (
    SELECT 1 FROM teams
...
--
-- Name: user_team_ids(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.user_team_ids() RETURNS SETOF uuid
    LANGUAGE sql STABLE SECURITY DEFINER
    AS $$
...
--
-- Name: ai_correction_memory; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.ai_correction_memory (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    user_id uuid NOT NULL,
    ...
    feedback_summary text GENERATED ALWAYS AS (((((('User moved "'::text || mistaken_text) || '" from '::text) || incorrect_field) || ' to '::text) || correct_field)) STORED,
    created_at timestamp with time zone DEFAULT now()
);
...
CREATE TABLE public.assets (
    ...
    created_at timestamp with time zone DEFAULT now(),
    CONSTRAINT assets_module_check CHECK ((module = ANY (ARRAY['contacts'::text, 'notes'::text, 'events'::text, 'tasks'::text, 'recordings'::text, 'general'::text])))
);
...
CREATE TABLE public.comments (
    ...
    CONSTRAINT comments_entity_type_check CHECK ((entity_type = ANY (ARRAY['event'::text, 'task'::text, 'note'::text])))
);


--
-- Name: contact_embeddings; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.contacts (
    ...
    pipeline_stage text DEFAULT 'contact'::text,
    ...
    other_phone text DEFAULT ''::text,
    tel_phone text DEFAULT ''::text,
    fax text DEFAULT ''::text,
    other_email text DEFAULT ''::text,
    ...
    back_image_url text,
    alt_language jsonb DEFAULT '{}'::jsonb,
    CONSTRAINT contacts_pipeline_stage_check CHECK ((pipeline_stage = ANY (ARRAY['lead'::text, 'contact'::text, 'client'::text])))
);
...
CREATE TABLE public.event_participants (
    ...
    CONSTRAINT event_participants_rsvp_status_check CHECK ((rsvp_status = ANY (ARRAY['pending'::text, 'accepted'::text, 'tentative'::text, 'declined'::text])))
);
...
CREATE TABLE public.events (
    ...
    linked_task_ids uuid[] DEFAULT '{}'::uuid[],
    linked_note_ids uuid[] DEFAULT '{}'::uuid[],
    linked_contact_ids uuid[] DEFAULT '{}'::uuid[],
    conference_url text,
...
CREATE TABLE public.focus_sessions (
    ...
    created_at timestamp with time zone DEFAULT now(),
    CONSTRAINT focus_sessions_session_type_check CHECK ((session_type = ANY (ARRAY['focus'::text, 'short_break'::text, 'long_break'::text])))
);


--
-- Name: id_mapping; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.id_mapping (
    ...
    CONSTRAINT id_mapping_entity_type_check CHECK ((entity_type = ANY (ARRAY['event'::text, 'task'::text, 'note'::text, 'contact'::text, 'journal'::text])))
);
...
CREATE TABLE public.recordings (
    ...
    created_at timestamp with time zone DEFAULT now(),
    CONSTRAINT recordings_status_check CHECK ((status = ANY (ARRAY['pending'::text, 'processing'::text, 'done'::text, 'failed'::text])))
);


--
-- Name: recurring_event_occurrences; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.recurring_event_occurrences (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    event_id uuid NOT NULL,
...
CREATE TABLE public.tasks (
    ...
    CONSTRAINT tasks_outcome_rating_check CHECK ((outcome_rating = ANY (ARRAY['great'::text, 'ok'::text, 'rough'::text]))),
...
CREATE TABLE public.team_invitations (
    ...
    responded_at timestamp with time zone,
    created_at timestamp with time zone DEFAULT now(),
    CONSTRAINT team_invitations_role_check CHECK ((role = ANY (ARRAY['admin'::text, 'member'::text, 'viewer'::text, 'guest'::text]))),
    CONSTRAINT team_invitations_status_check CHECK ((status = ANY (ARRAY['pending'::text, 'accepted'::text, 'declined'::text, 'expired'::text, 'revoked'::text])))
);
...
CREATE TABLE public.team_members (
    ...
    notification_prefs jsonb DEFAULT '{"tasks": true, "events": true, "comments": true}'::jsonb,
    CONSTRAINT team_members_role_check CHECK ((role = ANY (ARRAY['owner'::text, 'admin'::text, 'member'::text, 'viewer'::text, 'guest'::text])))
);
...
CREATE TABLE public.teams (
    ...
    created_at timestamp with time zone DEFAULT now(),
    updated_at timestamp with time zone DEFAULT now(),
    CONSTRAINT teams_default_role_check CHECK ((default_role = ANY (ARRAY['admin'::text, 'member'::text, 'viewer'::text])))
);
...
CREATE TABLE public.user_settings (
    ...
    flexible_events jsonb DEFAULT '{}'::jsonb,
    default_conference_type text,
    conference_links jsonb DEFAULT '{}'::jsonb,
    scheduling_links jsonb DEFAULT '[]'::jsonb,
    rooms jsonb DEFAULT '[]'::jsonb,
    email_reminders boolean DEFAULT true,
    email_digest text DEFAULT 'daily'::text,
    menu_bar_items jsonb DEFAULT '[]'::jsonb,
    theme text DEFAULT 'system'::text,
    created_at timestamp with time zone DEFAULT now(),
    updated_at timestamp with time zone DEFAULT now(),
    CONSTRAINT user_settings_default_view_check CHECK ((default_view = ANY (ARRAY['month'::text, 'week'::text, 'day'::text, 'year'::text])))
);
...
--
-- Name: ai_cache ai_cache_user_id_query_hash_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ai_cache
    ADD CONSTRAINT ai_cache_user_id_query_hash_key UNIQUE (user_id, query_hash);


--
-- Name: ai_correction_memory ai_correction_memory_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ai_correction_memory
    ADD CONSTRAINT ai_correction_memory_pkey PRIMARY KEY (id);
...
--
-- Name: contact_embeddings contact_embeddings_contact_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.contact_embeddings
    ADD CONSTRAINT contact_embeddings_contact_id_key UNIQUE (contact_id);


--
-- Name: contact_embeddings contact_embeddings_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.contact_embeddings
    ADD CONSTRAINT contact_embeddings_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public.contact_events
    ADD CONSTRAINT contact_events_pkey PRIMARY KEY (contact_id, event_id);
...
ALTER TABLE ONLY public.contact_tasks
    ADD CONSTRAINT contact_tasks_pkey PRIMARY KEY (contact_id, task_id);
...
--
-- Name: daily_journals daily_journals_user_id_journal_date_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.daily_journals
    ADD CONSTRAINT daily_journals_user_id_journal_date_key UNIQUE (user_id, journal_date);
...
--
-- Name: event_notes event_notes_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.event_notes
    ADD CONSTRAINT event_notes_pkey PRIMARY KEY (event_id, note_id);
...
--
-- Name: id_mapping id_mapping_entity_type_v1_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.id_mapping
    ADD CONSTRAINT id_mapping_entity_type_v1_id_key UNIQUE (entity_type, v1_id);


--
-- Name: id_mapping id_mapping_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: recurring_event_occurrences recurring_event_occurrences_event_id_occurrence_date_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.recurring_event_occurrences
    ADD CONSTRAINT recurring_event_occurrences_event_id_occurrence_date_key UNIQUE (event_id, occurrence_date);


--
-- Name: recurring_event_occurrences recurring_event_occurrences_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.recurring_event_occurrences
    ADD CONSTRAINT recurring_event_occurrences_pkey PRIMARY KEY (id);


--
-- Name: shared_calendars shared_calendars_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: contacts_favorite_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX contacts_favorite_idx ON public.contacts USING btree (user_id, is_favorite);


--
-- Name: contacts_name_trgm_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX contacts_name_trgm_idx ON public.contacts USING gin (name public.gin_trgm_ops);
...
--
-- Name: daily_journals_user_date_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX daily_journals_user_date_idx ON public.daily_journals USING btree (user_id, journal_date);
...
--
-- Name: events_user_date_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_ai_cache_expiry; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_ai_cache_expiry ON public.ai_cache USING btree (expires_at) WHERE (expires_at IS NOT NULL);


--
-- Name: idx_assets_user_module; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_assets_user_module ON public.assets USING btree (user_id, module);
...
--
-- Name: idx_contacts_fts; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_contacts_fts ON public.contacts USING gin (to_tsvector('english'::regconfig, ((((((((((((((COALESCE(name, ''::text) || ' '::text) || COALESCE(full_name, ''::text)) || ' '::text) || COALESCE(company, ''::text)) || ' '::text) || COALESCE(industry, ''::text)) || ' '::text) || COALESCE(department, ''::text)) || ' '::text) || COALESCE(email, ''::text)) || ' '::text) || COALESCE(notes, ''::text)) || ' '::text) || COALESCE(meeting_context, ''::text))));


--
-- Name: idx_contacts_full_name; Type: INDEX; Schema: public; Owner: -
--
...
CREATE INDEX idx_embeddings_vec ON public.contact_embeddings USING hnsw (embedding public.vector_cosine_ops);


--
-- Name: idx_events_recurrence; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_events_recurrence ON public.events USING btree (recurrence_rule) WHERE (recurrence_rule IS NOT NULL);
...
CREATE INDEX idx_events_user_time ON public.events USING btree (user_id, start_time);


--
-- Name: idx_focus_sessions_completed; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_focus_sessions_completed ON public.focus_sessions USING btree (task_id, duration_minutes) WHERE ((completed = true) AND (task_id IS NOT NULL));


--
-- Name: idx_focus_sessions_task; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_focus_sessions_task ON public.focus_sessions USING btree (task_id) WHERE (task_id IS NOT NULL);


--
-- Name: idx_focus_sessions_user; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_focus_sessions_user ON public.focus_sessions USING btree (user_id, started_at DESC);


--
-- Name: idx_focus_sessions_user_date; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_focus_sessions_user_date ON public.focus_sessions USING btree (user_id, started_at) WHERE ((completed = true) AND (session_type = 'focus'::text));


--
-- Name: idx_id_mapping_entity; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_id_mapping_entity ON public.id_mapping USING btree (entity_type, v1_id);
...
CREATE INDEX idx_invitations_email ON public.team_invitations USING btree (invitee_email);
...
CREATE INDEX idx_invitations_token ON public.team_invitations USING btree (invite_token);
...
--
-- Name: idx_notes_user_vault; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_notes_user_vault ON public.notes USING btree (user_id, vault_path) WHERE (vault_path IS NOT NULL);
...
--
-- Name: idx_occurrences_event; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_occurrences_event ON public.recurring_event_occurrences USING btree (event_id, occurrence_date);
...
CREATE INDEX idx_recordings_status ON public.recordings USING btree (status) WHERE (status = ANY (ARRAY['pending'::text, 'processing'::text]));


--
-- Name: idx_subtasks_parent; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_subtasks_parent ON public.subtasks USING btree (parent_task_id, sort_order);
...
CREATE INDEX idx_tasks_status ON public.tasks USING btree (user_id, status, due_date);


--
-- Name: idx_tasks_user_due; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: notes_fts_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX notes_fts_idx ON public.notes USING gin (to_tsvector('english'::regconfig, ((COALESCE(title, ''::text) || ' '::text) || COALESCE(content, ''::text))));


--
-- Name: notes_linked_date_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX notes_linked_date_idx ON public.notes USING btree (user_id, linked_date);


--
-- Name: notes_pinned_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX notes_pinned_idx ON public.notes USING btree (user_id, is_pinned);
...
CREATE INDEX tasks_due_date_idx ON public.tasks USING btree (user_id, due_date);


--
-- Name: tasks_scheduled_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX tasks_scheduled_idx ON public.tasks USING btree (user_id, scheduled_date);
...
CREATE INDEX tasks_status_idx ON public.tasks USING btree (user_id, status);
...
--
-- Name: events cleanup_event_comments; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER cleanup_event_comments BEFORE DELETE ON public.events FOR EACH ROW EXECUTE FUNCTION public.delete_entity_comments('event');


--
-- Name: notes cleanup_note_comments; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER cleanup_note_comments BEFORE DELETE ON public.notes FOR EACH ROW EXECUTE FUNCTION public.delete_entity_comments('note');


--
-- Name: tasks cleanup_task_comments; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER cleanup_task_comments BEFORE DELETE ON public.tasks FOR EACH ROW EXECUTE FUNCTION public.delete_entity_comments('task');
...
--
-- Name: daily_journals daily_journals_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER daily_journals_updated_at BEFORE UPDATE ON public.daily_journals FOR EACH ROW EXECUTE FUNCTION public.handle_updated_at();
...
--
-- Name: contacts set_contacts_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: journal_entries set_journal_entries_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: shared_calendars set_shared_calendars_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER set_shared_calendars_updated_at BEFORE UPDATE ON public.shared_calendars FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();
...
ALTER TABLE ONLY public.ai_cache
    ADD CONSTRAINT ai_cache_user_id_fkey FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE CASCADE;


--
-- Name: ai_correction_memory ai_correction_memory_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ai_correction_memory
    ADD CONSTRAINT ai_correction_memory_user_id_fkey FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE CASCADE;
...
--
-- Name: contact_embeddings contact_embeddings_contact_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.contact_embeddings
    ADD CONSTRAINT contact_embeddings_contact_id_fkey FOREIGN KEY (contact_id) REFERENCES public.contacts(id) ON DELETE CASCADE;


--
-- Name: contact_events contact_events_contact_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.contact_events
    ADD CONSTRAINT contact_events_contact_id_fkey FOREIGN KEY (contact_id) REFERENCES public.contacts(id) ON DELETE CASCADE;


--
-- Name: contact_events contact_events_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.contact_events
    ADD CONSTRAINT contact_events_event_id_fkey FOREIGN KEY (event_id) REFERENCES public.events(id) ON DELETE CASCADE;
...
--
-- Name: contact_notes contact_notes_note_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: contact_tasks contact_tasks_task_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.contact_tasks
    ADD CONSTRAINT contact_tasks_task_id_fkey FOREIGN KEY (task_id) REFERENCES public.tasks(id) ON DELETE CASCADE;
...
--
-- Name: daily_journals daily_journals_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.daily_journals
    ADD CONSTRAINT daily_journals_user_id_fkey FOREIGN KEY (user_id) REFERENCES auth.users(id);
...
--
-- Name: event_notes event_notes_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: event_notes event_notes_note_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.event_notes
    ADD CONSTRAINT event_notes_note_id_fkey FOREIGN KEY (note_id) REFERENCES public.notes(id) ON DELETE CASCADE;
...
--
-- Name: recordings recordings_note_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.recordings
    ADD CONSTRAINT recordings_note_id_fkey FOREIGN KEY (note_id) REFERENCES public.notes(id) ON DELETE SET NULL;
...
--
-- Name: recurring_event_occurrences recurring_event_occurrences_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.recurring_event_occurrences
    ADD CONSTRAINT recurring_event_occurrences_event_id_fkey FOREIGN KEY (event_id) REFERENCES public.events(id) ON DELETE CASCADE;


--
-- Name: shared_calendars shared_calendars_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.shared_calendars
    ADD CONSTRAINT shared_calendars_created_by_fkey FOREIGN KEY (created_by) REFERENCES auth.users(id);


--
-- Name: shared_calendars shared_calendars_team_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.shared_calendars
    ADD CONSTRAINT shared_calendars_team_id_fkey FOREIGN KEY (team_id) REFERENCES public.teams(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.team_activity
    ADD CONSTRAINT team_activity_team_id_fkey FOREIGN KEY (team_id) REFERENCES public.teams(id) ON DELETE CASCADE;


--
-- Name: team_activity team_activity_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.team_activity
    ADD CONSTRAINT team_activity_user_id_fkey FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE SET NULL;
...
--
-- Name: team_invitations team_invitations_invitee_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.team_invitations
    ADD CONSTRAINT team_invitations_invitee_user_id_fkey FOREIGN KEY (invitee_user_id) REFERENCES auth.users(id);
...
--
-- Name: comments Create comments; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Create comments" ON public.comments FOR INSERT WITH CHECK ((user_id = auth.uid()));


--
-- Name: contacts Create contacts; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Create contacts" ON public.contacts FOR INSERT WITH CHECK ((user_id = auth.uid()));


--
-- Name: team_invitations Create invitation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Create invitation" ON public.team_invitations FOR INSERT WITH CHECK ((team_id IN ( SELECT team_members.team_id
   FROM public.team_members
  WHERE ((team_members.user_id = auth.uid()) AND (team_members.role = ANY (ARRAY['owner'::text, 'admin'::text]))))));


--
-- Name: notes Create notes; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Create notes" ON public.notes FOR INSERT WITH CHECK ((user_id = auth.uid()));


--
-- Name: task_activity Create task activity; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Create task activity" ON public.task_activity FOR INSERT WITH CHECK ((user_id = auth.uid()));


--
-- Name: team_activity Create team activity; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Create team activity" ON public.team_activity FOR INSERT WITH CHECK ((team_id IN ( SELECT public.user_team_ids() AS user_team_ids)));


--
-- Name: teams Create teams; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Create teams" ON public.teams FOR INSERT WITH CHECK (((auth.uid() IS NOT NULL) AND (created_by = auth.uid())));


--
-- Name: comments Delete own comments; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: teams Delete teams; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Delete teams" ON public.teams FOR DELETE USING ((id IN ( SELECT team_members.team_id
   FROM public.team_members
  WHERE ((team_members.user_id = auth.uid()) AND (team_members.role = 'owner'::text)))));


--
-- Name: team_members Join team; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Join team" ON public.team_members FOR INSERT WITH CHECK ((((user_id = auth.uid()) AND (role = 'owner'::text) AND public.is_team_creator(team_id, auth.uid())) OR ((user_id = auth.uid()) AND (EXISTS ( SELECT 1
   FROM public.team_invitations
  WHERE ((team_invitations.team_id = team_members.team_id) AND (team_invitations.invitee_user_id = auth.uid()) AND (team_invitations.status = 'accepted'::text))))) OR public.is_team_admin(team_id, auth.uid())));


--
-- Name: team_members Leave or remove member; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Leave or remove member" ON public.team_members FOR DELETE USING (((user_id = auth.uid()) OR public.is_team_admin(team_id, auth.uid())));


--
-- Name: event_participants Manage RSVP; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Manage RSVP" ON public.event_participants USING ((user_id = auth.uid()));


--
-- Name: shared_calendars Manage shared calendars; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Manage shared calendars" ON public.shared_calendars USING ((team_id IN ( SELECT team_members.team_id
   FROM public.team_members
  WHERE ((team_members.user_id = auth.uid()) AND (team_members.role = ANY (ARRAY['owner'::text, 'admin'::text]))))));


--
-- Name: teams Manage teams; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Manage teams" ON public.teams FOR UPDATE USING ((id IN ( SELECT team_members.team_id
   FROM public.team_members
  WHERE ((team_members.user_id = auth.uid()) AND (team_members.role = ANY (ARRAY['owner'::text, 'admin'::text]))))));


--
-- Name: ai_cache Own ai_cache; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Own ai_cache" ON public.ai_cache USING ((user_id = auth.uid()));


--
-- Name: ai_correction_memory Own ai_corrections; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Own ai_corrections" ON public.ai_correction_memory USING ((user_id = auth.uid()));


--
-- Name: assets Own assets; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Own assets" ON public.assets USING ((user_id = auth.uid()));


--
-- Name: contact_embeddings Own embeddings; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Own embeddings" ON public.contact_embeddings USING ((contact_id IN ( SELECT contacts.id
   FROM public.contacts
  WHERE (contacts.user_id = auth.uid()))));


--
-- Name: focus_sessions Own focus sessions; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Own focus sessions" ON public.focus_sessions USING ((user_id = auth.uid()));


--
-- Name: journal_entries Own journal; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Own journal" ON public.journal_entries USING ((user_id = auth.uid()));


--
-- Name: id_mapping Own migration records; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Own migration records" ON public.id_mapping USING ((v2_id IN ( SELECT events.id
   FROM public.events
...
CREATE POLICY "Own notifications" ON public.notifications USING ((user_id = auth.uid()));
...
--
-- Name: recordings Own recordings; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Own recordings" ON public.recordings USING ((user_id = auth.uid()));


--
-- Name: device_tokens Own tokens; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Own tokens" ON public.device_tokens USING ((user_id = auth.uid()));


--
-- Name: team_invitations Respond to invitation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Respond to invitation" ON public.team_invitations FOR UPDATE USING (((invitee_user_id = auth.uid()) OR (invitee_email = (( SELECT users.email
   FROM auth.users
  WHERE (users.id = auth.uid())))::text)));


--
-- Name: comments Update own comments; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Update own comments" ON public.comments FOR UPDATE USING ((user_id = auth.uid()));


--
-- Name: team_invitations View invitations; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "View invitations" ON public.team_invitations FOR SELECT USING (((team_id IN ( SELECT public.user_team_ids() AS user_team_ids)) OR (invitee_email = (( SELECT users.email
   FROM auth.users
  WHERE (users.id = auth.uid())))::text) OR (invitee_user_id = auth.uid())));


--
-- Name: team_members View members; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "View members" ON public.team_members FOR SELECT USING ((team_id IN ( SELECT public.user_team_ids() AS user_team_ids)));


--
-- Name: shared_calendars View shared calendars; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "View shared calendars" ON public.shared_calendars FOR SELECT USING ((team_id IN ( SELECT public.user_team_ids() AS user_team_ids)));


--
-- Name: teams View teams; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "View teams" ON public.teams FOR SELECT USING (((id IN ( SELECT public.user_team_ids() AS user_team_ids)) OR (created_by = auth.uid())));
...
--
-- Name: ai_correction_memory; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: contact_embeddings; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: daily_journals; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: event_notes; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: event_tasks; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: focus_sessions; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.focus_sessions ENABLE ROW LEVEL SECURITY;

--
-- Name: id_mapping; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: recurring_event_occurrences; Type: ROW SECURITY; Schema: public; Owner: -
--
...
CREATE POLICY "users manage own contacts" ON public.contacts USING ((auth.uid() = user_id));


--
-- Name: events users manage own events; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "users manage own events" ON public.events USING ((auth.uid() = user_id));


--
-- Name: daily_journals users manage own journals; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "users manage own journals" ON public.daily_journals USING ((auth.uid() = user_id));
...
CREATE POLICY "users manage own notes" ON public.notes USING ((auth.uid() = user_id));
...
--
-- Name: objects auth_upload; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY auth_upload ON storage.objects FOR INSERT TO authenticated WITH CHECK ((bucket_id = 'contact-cards'::text));
...
--
-- Name: supabase_realtime daily_journals; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.daily_journals;
...
--
-- Name: supabase_realtime notes; Type: PUBLICATION TABLE; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION cleanup_expired_ai_cache(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION cleanup_old_activity_data(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION delete_entity_comments(); Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON FUNCTION public.delete_entity_comments() TO anon;
GRANT ALL ON FUNCTION public.delete_entity_comments() TO authenticated;
GRANT ALL ON FUNCTION public.delete_entity_comments() TO service_role;
...
--
-- Name: FUNCTION is_team_admin(p_team_id uuid, p_user_id uuid); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION is_team_creator(p_team_id uuid, p_user_id uuid); Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON FUNCTION public.is_team_creator(p_team_id uuid, p_user_id uuid) TO anon;
GRANT ALL ON FUNCTION public.is_team_creator(p_team_id uuid, p_user_id uuid) TO authenticated;
GRANT ALL ON FUNCTION public.is_team_creator(p_team_id uuid, p_user_id uuid) TO service_role;
...
--
-- Name: FUNCTION user_team_ids(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE ai_cache; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE ai_correction_memory; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON TABLE public.ai_correction_memory TO anon;
GRANT ALL ON TABLE public.ai_correction_memory TO authenticated;
GRANT ALL ON TABLE public.ai_correction_memory TO service_role;
...
--
-- Name: TABLE contact_embeddings; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON TABLE public.contact_embeddings TO anon;
GRANT ALL ON TABLE public.contact_embeddings TO authenticated;
GRANT ALL ON TABLE public.contact_embeddings TO service_role;
...
--
-- Name: TABLE contact_tasks; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON TABLE public.contact_tasks TO anon;
GRANT ALL ON TABLE public.contact_tasks TO authenticated;
GRANT ALL ON TABLE public.contact_tasks TO service_role;
...
--
-- Name: TABLE daily_journals; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON TABLE public.daily_journals TO anon;
GRANT ALL ON TABLE public.daily_journals TO authenticated;
GRANT ALL ON TABLE public.daily_journals TO service_role;
...
--
-- Name: TABLE event_notes; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE event_tasks; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE focus_sessions; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE id_mapping; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON TABLE public.id_mapping TO anon;
GRANT ALL ON TABLE public.id_mapping TO authenticated;
GRANT ALL ON TABLE public.id_mapping TO service_role;
...
--
-- Name: TABLE recordings; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE recurring_event_occurrences; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON TABLE public.recurring_event_occurrences TO anon;
GRANT ALL ON TABLE public.recurring_event_occurrences TO authenticated;
GRANT ALL ON TABLE public.recurring_event_occurrences TO service_role;


--
-- Name: TABLE shared_calendars; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE task_activity; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE team_activity; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE messages_2026_04_12; Type: ACL; Schema: realtime; Owner: -
--
